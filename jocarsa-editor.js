window.JocarsaEditor = (function(){
	...
	function crearTabla(instancia){
		...
		let html = '<table class="jocarsa-editor-tabla"><tbody>';
	...
	function crearBoton(html, titulo, onClick, claseExtra = ""){
		...
		boton.type = "button";
		boton.className = claseExtra ? "jocarsa-editor-boton " + claseExtra : "jocarsa-editor-boton";
	...
	function crearSelect(titulo, opciones, onChange, claseExtra = ""){
		...
		select.className = claseExtra ? "jocarsa-editor-select " + claseExtra : "jocarsa-editor-select";
		select.title = titulo;
	...
	function crearColorPicker(titulo, valorInicial, onInput){
		...
		input.type = "color";
		input.className = "jocarsa-editor-color";
		input.title = titulo;
	...
	function crearBarra(instancia){
		...
		barra.className = "jocarsa-editor-barra";
		...
		separador1.className = "jocarsa-editor-separador";
		...
		separador2.className = "jocarsa-editor-separador";
		...
		separador3.className = "jocarsa-editor-separador";
		...
		separador4.className = "jocarsa-editor-separador";
	...
	function crearEditor(textarea){
		if(textarea.dataset.jocarsaEditorInicializado === "1"){
			return;
		}

		let contenedor = document.createElement("div");
		contenedor.className = "jocarsa-editor-contenedor";

		let editor = document.createElement("div");
		editor.className = "jocarsa-editor-editor";
		editor.contentEditable = true;
		editor.spellcheck = true;

		editor.innerHTML = textarea.value.trim() || "<p><br></p>";

		textarea.classList.add("jocarsa-editor-textarea-oculto");
		...
		textarea.dataset.jocarsaEditorInicializado = "1";
		sincronizarTextarea(instancia);
	}

	function init(contexto = document){
		let areas = contexto.querySelectorAll("textarea.jocarsa-editor");
